export const modelGroups = [
  ...
  },
  {
    label: 'OpenAI',
    items: [
      { label: 'GPT-5', value: { provider: 'openai', name: 'gpt-5' }, disabled: true },
      { label: 'GPT-5.1', value: { provider: 'openai', name: 'gpt-5.1' }, disabled: true },
    ],
  },
  {
    label: 'Google Gemini',
  ...
  },
  {
    label: 'xAI',
    items: [
      { label: 'Grok 3', value: { provider: 'xai', name: 'grok-3' }, disabled: true },
      {
        label: 'Grok 4',
